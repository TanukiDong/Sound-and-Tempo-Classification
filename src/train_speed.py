...
from utils import augment_data, average_frames, select_scaler
...
def create_pipeline() -> Pipeline:
    ...
    steps = [
        # 1. Average frames
        ("average_frames", FunctionTransformer(average_frames, kw_args={"n_channels": N_CHANNELS, "n_frames": N_FRAMES}, validate=False)),
        # 2. Scaler
        ("scaler", scaler),
    ]
